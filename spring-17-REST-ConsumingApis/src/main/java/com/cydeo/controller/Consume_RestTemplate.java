...
public class Consume_RestTemplate {
    ...
    //    in this method we can bring changes based on our need and requirements.
    @GetMapping
    ...
    //in this method we have no control over the method and can not manipulate the method based or our wants
    @GetMapping("{id}")
